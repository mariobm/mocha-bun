...
let createUnparsableFileError, isMochaError;
try { ({createUnparsableFileError, isMochaError} = require("../errors.cjs")); } catch { ({createUnparsableFileError, isMochaError} = require("../errors.js")); }
