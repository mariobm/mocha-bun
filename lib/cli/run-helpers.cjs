...
const { watchRun, watchParallelRun } = require("./watch-run.cjs");
const collectFiles = require("./collect-files.cjs");
const { format } = require("node:util");
let createInvalidLegacyPluginError;
try { ({createInvalidLegacyPluginError} = require("../errors.cjs")); } catch { ({createInvalidLegacyPluginError} = require("../errors.js")); }
