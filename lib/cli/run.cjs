...
let createUnsupportedError, createInvalidArgumentValueError, createMissingArgumentError;
try { ({createUnsupportedError, createInvalidArgumentValueError, createMissingArgumentError} = require("../errors.cjs")); } catch { ({createUnsupportedError, createInvalidArgumentValueError, createMissingArgumentError} = require("../errors.js")); }
