...
let createInvalidExceptionError, createUnsupportedError, createFatalError, isMochaError;
try { ({createInvalidExceptionError, createUnsupportedError, createFatalError, isMochaError} = require("./errors.cjs")); } catch { ({createInvalidExceptionError, createUnsupportedError, createFatalError, isMochaError} = require("./errors.js")); }
let errorConstants;
try { ({constants: errorConstants} = require("./error-constants.cjs")); } catch { ({constants: errorConstants} = require("./error-constants.js")); }
