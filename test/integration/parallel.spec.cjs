...
describe("parallel run", () => {
  ...
  it('should allow `import {it} from "mocha"` module syntax', async () => {
    const result = await runMochaJSONAsync("parallel/test3.js", [
      "--parallel",
      "--jobs",
      "2",
      require.resolve("./fixtures/parallel/test1.js"),
      require.resolve("./fixtures/parallel/test2.js"),
    ]);
  ...
  it("should correctly set worker ids for each process", async () => {
    const result = await runMochaJSONAsync("parallel/testworkerid3.js", [
      "--parallel",
      "--jobs",
      "2",
      require.resolve("./fixtures/parallel/testworkerid1.js"),
      require.resolve("./fixtures/parallel/testworkerid2.js"),
    ]);
